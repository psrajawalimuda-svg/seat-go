...
export const PICKUP_POINTS: PickupPoint[] = [
  { id: "j1", label: "J1", name: "Terminal Utama", order: 1, minutesFromStart: 0 },
  { id: "j2", label: "J2", name: "Perumahan Griya", order: 2, minutesFromStart: 3 },
  { id: "j3", label: "J3", name: "Simpang Tiga", order: 3, minutesFromStart: 6 },
  { id: "j4", label: "J4", name: "Pasar Lama", order: 4, minutesFromStart: 9 },
  { id: "j5", label: "J5", name: "Masjid Al-Ikhlas", order: 5, minutesFromStart: 12 },
  { id: "j6", label: "J6", name: "Taman Kota", order: 6, minutesFromStart: 15 },
  { id: "j7", label: "J7", name: "RS Harapan", order: 7, minutesFromStart: 18 },
  { id: "j8", label: "J8", name: "Kampus UNRI", order: 8, minutesFromStart: 22 },
  { id: "j9", label: "J9", name: "Mall SKA", order: 9, minutesFromStart: 26 },
  { id: "j10", label: "J10", name: "Bundaran Pesona", order: 10, minutesFromStart: 30 },
  { id: "j11", label: "J11", name: "Jl. Sudirman", order: 11, minutesFromStart: 34 },
  { id: "j12", label: "J12", name: "Gedung Sate", order: 12, minutesFromStart: 38 },
  { id: "j13", label: "J13", name: "Halte BRT", order: 13, minutesFromStart: 42 },
  { id: "j14", label: "J14", name: "Stasiun KA", order: 14, minutesFromStart: 46 },
  { id: "j15", label: "J15", name: "Bandara Husein", order: 15, minutesFromStart: 50 },
  { id: "j16", label: "J16", name: "Terminal Akhir", order: 16, minutesFromStart: 55 },
  { id: "j17", label: "J17", name: "Pelabuhan", order: 17, minutesFromStart: 60 },
];
